...
class Exercise004Test extends AnyFlatSpec{
  ...
  it should "be returned when constructed with a date and time" ignore {
  ...
  it should "be returned when constructed with a date and time with day roll over" ignore {
